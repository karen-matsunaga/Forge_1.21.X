...
public class DisenchantBlock extends Block {
    ...
    public void appendHoverText(@NotNull ItemStack stack, @NotNull TooltipContext context,
        ...
        if (type == 1) {
            tooltipLine(list, "1. Enchanted Tool NEAR -> Grouped book + Tool without enchantments;", aqua);
            tooltipLine(list, "2. Enchanted Tool FAR -> Separate book + Tool without enchantments.", darkAqua);
        }
        if (type == 2) { tooltipLine(list, "The books separate but remain at the original level.", green); }
