...
public class ModBlockLootTableProvider extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.add(ModBlocks.ALEXANDRITE_END_ORE.get(),
                block -> createMultipleOreDrops(ModBlocks.ALEXANDRITE_END_ORE.get(),
                                                      ModItems.RAW_ALEXANDRITE.get(), 4, 8));

        this.add(ModBlocks.ALEXANDRITE_NETHER_ORE.get(),
                block -> createMultipleOreDrops(ModBlocks.ALEXANDRITE_NETHER_ORE.get(),
                                                      ModItems.RAW_ALEXANDRITE.get(), 1, 6));
